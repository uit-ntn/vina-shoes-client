  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        <p>
          Welcome to Vina Shoes. Please read these Terms of Service ("Terms") carefully before using 
          our website and services. Your access to and use of the service is conditioned on your 
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Purchases</h2>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Product Descriptions</h2>
        
        <p>
          We endeavor to be as accurate as possible with our products. However, we do not warrant that 
          product descriptions or other content of the site is accurate, complete, reliable, current, or 
          error-free. If a product offered by Vina Shoes is not as described, your sole remedy is to return 
        ...
        <p>
          All prices are shown in USD and are exclusive of taxes and shipping costs (which are calculated 
          and displayed during the checkout process). We reserve the right to modify prices at any time, 
          and products in your shopping cart are subject to price changes.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Availability, Errors and Inaccuracies</h2>
        ...
        <p>
          ...
          property of Vina Shoes and its licensors. The Service is protected by copyright, trademark, and other 
          laws of both Vietnam and foreign countries. Our trademarks and trade dress may not be used in connection 
          with any product or service without the prior written consent of Vina Shoes.
        </p>
        ...
        <p className="mt-4">
          Vina Shoes has no control over, and assumes no responsibility for, the content, privacy policies, or 
          practices of any third-party web sites or services. You further acknowledge and agree that Vina Shoes 
        ...
        <p>
          In no event shall Vina Shoes, nor its directors, employees, partners, agents, suppliers, or affiliates, 
        ...
        <ul className="list-none pl-0 mb-4">
          <li>Email: legal@vinashoes.com</li>
