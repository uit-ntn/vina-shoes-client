...
const ProductCard = ({ product, onToggleWishlist, isInWishlist = false }: Omit<ProductCardProps, 'onAddToCart'>) => {
  // const fallbackImageUrl = '/images/product-placeholder.jpg'; // For future use
