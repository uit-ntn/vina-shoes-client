      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          ...
          <div className="mt-6 text-center text-sm font-semibold text-white py-4 px-6 rounded-lg shadow-lg">
            <p>
              Trang web này được thiết kế và phát triển chuyên nghiệp bởi sinh viên UIT Nguyễn Thanh Nhân. Sứ mệnh của chúng tôi là mang đến trải nghiệm mua sắm giày dép cao cấp và liền mạch, kết hợp công nghệ hiện đại, thiết kế lấy người dùng làm trung tâm và cam kết về chất lượng.
            </p>
          </div>
        </div>
      </div>
